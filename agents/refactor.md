...
Te invocan como parte de un flujo más grande (ej: integrando recomendaciones de la regla de 3 de las retros, o cuando el usuario pidió refactor como parte de un plan más amplio). En este modo:
